...
created: 2026-07-21
updated: 2026-07-22
tags: [meta, validation-checklist, historical]
status: historical
related: ["[[migration-audit]]", "[[Dux]]", "[[index]]"]
---

# Validation Checklist — Dux Corpus, Per-File

Navigation: [[index]] | [[migration-audit]] | [[Dux]]

> **Frozen historical record**, preserved unchanged from the 2026-07-21 ingest verification pass. On 2026-07-22 the 74 notes named throughout this checklist were consolidated into 15 dense guides (see [[Dux]]). Wikilink brackets have been stripped so this page no longer reports dead links; the destination-note names below are historical and no longer resolve. See `migration-audit` for the summary this checklist backs.
...
| Source | Destination note(s) | Result |
|---|---|---|
| `ci-cd-testing.md` | CI/CD & Testing | ✅ 23/31; AI-75/KS-002/003/004/005/006/ISO-013/TR-NFR-007 are 🔵 — the cost-benchmark, kill-switch test suite, and golden-set regression gate are all covered, these are specific sub-test-case IDs |
