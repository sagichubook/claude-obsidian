...
created: 2026-07-21
updated: 2026-07-22
tags: [meta, migration-audit, historical]
status: historical
related: ["[[index]]", "[[log]]", "[[Dux]]"]
---

# Migration Audit — Dux Corpus Ingest (2026-07-21)

Navigation: [[index]] | [[log]] | [[Dux]]

> **Frozen historical record.** This report documents the verification rigor behind the original Dux corpus ingest on 2026-07-21: 68/68 source files mirrored, four independent verification passes, 19 real gaps found and fixed. On 2026-07-22 the 74 notes this report reconciles were consolidated into 15 dense guides (see [[Dux]] for the current structure). The page names below (e.g. "Dux Product Overview," "Dux Decisions Log") refer to notes that no longer exist under those names; every fact they carried was verified against `.raw/dux/` and carried into the new guides during consolidation. Wikilink brackets have been stripped throughout so this page no longer reports dead links, but the content itself is left as originally written. Treat this as history, not navigation.
...
| `50-engineering/` | 3 | Engineering Standards, CI/CD & Testing, Local Development | 3/3 |
...
| Cost gate figures | `decisions-log.md`/`ci-cd-testing.md`: $0.675 soft breaker, $0.55 CI gate, $0.75 Gate-1 hard | CI/CD & Testing, Quick Reference Card | Match |
